                    ...
                    <nav class="menus">
                        <ul>
                            <li class="deroulant"><a href="#">Artiste</a>
                                <ul class="sous">
                                <?php
                                      $sql2 = "SELECT DISTINCT artiste FROM produits ";
                                      $req2 = mysqli_query($connexion,$sql2);
                                      while ($dataa = mysqli_fetch_array($req2))
                                        {
                                            echo'<li><a href="produit.php?art=',$dataa['artiste'],'">'.$dataa['artiste'].'</a></li>';
                                        }
                                ?>    
                                </ul>
                            </li>
                    ...
                    <nav class="menus">
                        <ul>
                            <li class="deroulant"><a href="#">Type</a>
                                <ul class="sous">
                                <?php
                                      $sqlz2 = "SELECT DISTINCT type FROM produits ";
                                      $reqz2 = mysqli_query($connexion,$sqlz2);
                                    while ($dataaa = mysqli_fetch_array($reqz2))
                                    {
                                        echo'<li><a href="produit.php?type=' , $dataaa['type'] , '">'.$dataaa['type'].'</a></li>';
                                    }
                                ?>    
                                </ul>
                            </li>
